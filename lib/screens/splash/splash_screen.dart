...
import 'package:saveyourmoney/onboardingScreen/screen/onboarding_screen.dart';
      ...
      body: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: const [Color.fromARGB(255, 231, 129, 101), Color.fromARGB(255, 237, 185, 51), Color.fromARGB(255, 236, 199, 148)],
